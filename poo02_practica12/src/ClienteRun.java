...
public class ClienteRun implements Runnable {

    private final byte numCliente;
    private final String[] pedido;

    public ClienteRun(byte numCliente, String[] pedido) {
        this.numCliente = numCliente;
        this.pedido = pedido;
        System.out.println("Soy el cliente no. " + this.numCliente);
    }
    ...
    public void run() {
        try {
            ...
            System.out.println(":( Hilo interrumpiso.\n");
        }
    }
}
